...
export default function MarksEntryClient({ assignedStudents }: MarksEntryClientProps) {
  ...
  // Mark all loaded students as Absent
  const markAllAbsent = () => {
    if (students.length === 0) return;
    setStudents(prev => prev.map(s => ({
      ...s,
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50/70 border-b border-slate-150 text-slate-500 text-[10px] font-extrabold uppercase tracking-widest">
                  ...
                  <th className="py-3 px-6 w-60 text-center">
                    <div className="flex flex-col items-center gap-1.5">
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <button
                          ...
                          className="px-2.5 py-1.5 rounded-xl border border-emerald-200 text-emerald-600 bg-emerald-50 hover:bg-emerald-100/50 text-[9px] font-black uppercase tracking-wider transition-all cursor-pointer shadow-3xs active:scale-95"
                        >
                          All Present
                        </button>
                        <button
                          ...
                          className="px-2.5 py-1.5 rounded-xl border border-rose-200 text-rose-600 bg-rose-50 hover:bg-rose-100/50 text-[9px] font-black uppercase tracking-wider transition-all cursor-pointer shadow-3xs active:scale-95"
                        >
                          All Absent
                        </button>
                      </div>
